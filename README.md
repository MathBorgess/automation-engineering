# Projeto: Identificação e Controle de um Sistema de Levitação de Esfera Acionado por Ventilador. 
Desenvolvido pelo grupo 1 do período de 2025.2 de Automação Inteligente (IF705) – CIn/UFPE
